...
class Calculator1:
    '''
    * Um numero é dividido em 3 partes iguais. OK
    * A primeira parte é dividida por 4 e seu resultado somado a 7
    Após isso, o resultado é elevado ao
    quadrado e multiplicado por um valor de 0.257 OK
    * A segunda parte é elevada a potência de 2.121, dividida por 5 e somado a 1 OK
    * A terceira parte se mantém no mesmo valor OK
